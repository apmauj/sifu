...
class TestUREndpoints:
    ...
    def mock_ur_service(self):
        ...
        with patch("src.api.routers.ur.URService") as mock:
    ...
    def test_get_latest_ur_success(self, client, mock_ur_service):
        ...
        with patch("src.infrastructure.database.get_db"):
    ...
    def test_refresh_ur_data_success(self, client):
        ...
        with patch("src.api.routers.ur.ur_excel_processor") as mock_processor:
