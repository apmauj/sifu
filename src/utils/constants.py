...
LOG_DOWNLOADING_EXCEL_INE_UR_PRIMARY = "Descargando archivo Excel de UR desde INE (fuente primaria)..."
LOG_DOWNLOADING_EXCEL_BHU_FALLBACK = "INE no disponible, intentando fallback a BHU para UR..."
