...
function Initialize-ContainerIfNeeded {
	param(
...
Initialize-ContainerIfNeeded -ContainerName 'sifu-backend' -ComposeService 'backend' -ComposeFilePath $resolvedComposeFile
Initialize-ContainerIfNeeded -ContainerName 'sifu-tunnel' -ComposeService 'tunnel' -ComposeFilePath $resolvedComposeFile
