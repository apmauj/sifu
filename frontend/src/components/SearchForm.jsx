      ...
      <div className="mb-6">
        ...
        <div className="flex space-x-4 mb-4">
          <label className="flex items-center" htmlFor="searchType-single">
            ...
            />
            <span className="text-sm font-medium text-gray-700">{t('ui.specific_date') || 'Fecha específica'}</span>
          </label>
          <label className="flex items-center" htmlFor="searchType-range">
            <input
              ...
              className="mr-2 text-uruguay-blue focus:ring-uruguay-blue"
            />
            <span className="text-sm font-medium text-gray-700">{t('ui.date_range') || 'Rango de fechas'}</span>
          </label>
        </div>
      </div>
