// Lightweight inline SVG flags to replace emoji (consistent across browsers)
// Only currencies we currently display. Accessible with title + aria-hidden pattern.
// Dimensions use 4:3 ratio (24x18) similar to common flag icon sets.
